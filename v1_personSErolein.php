...
$vmc = $_REQUEST['VerificationMasterCode'];
$vc0 = $_REQUEST['VC0'];
$vc1 = $_REQUEST['VC1'];
$vc2 = $_REQUEST['VC2'];
$vc3 = $_REQUEST['VC3'];
...
if ( $vc == XCrypt($vmc,"Dice","decrypt") ) {
    ...
    if ($GLOBALS{'IOWARNING'} == "1") {
        ...
        if ($fromemail != "") {		
            ...
            print "<BR>Please enter a valid email address for us to reply to."; 
        }
    }
} else {  
    print "<BR>Invalid Verification Code."; 
}
