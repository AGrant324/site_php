...
if ($selectid == "ACCREDACTIONVIEWLIST") { Library_ACCREDACTIONVIEWLIST_CSSJS(); }
if ($selectid == "ACCREDACTIONTRACKER") { Library_ACCREDACTIONTRACKER_CSSJS(); }
...
if ($selectid == "SETUPCORCURRENTUSE") { GenericHandler_CSSJS(); }
...
if ($selectid == "DMWSSULISTARCHIVED") { Dmws_DMWSSULIST_CSSJS(); }
...
if ($selectid == "SETUPSFMTEAM") { SFM_SETUPSFMTEAM_CSSJS(); }
if ($selectid == "SETUPSFMFACILITY") { SFM_SETUPSFMFACILITY_CSSJS(); }
if ($selectid == "SETUPSFMOPERATOR") { SFM_SETUPSFMOPERATOR_CSSJS(); }
...
if ($selectid == "SFMBYLEAGUELIST") { SFM_SFMLISTS_CSSJS(); }
if ($selectid == "SFMSEARCHLIST") { SFM_SFMLISTS_CSSJS(); }

if ($selectid == "DASHBOARD") {  $GLOBALS{'dashboardsectionsprovided'} = "1"; }
...
if ($selectid == "ACTIONSVIEWNEW") { Action_VIEWLIST_Output(); } 
...
if ($selectid == "ACCREDACTIONVIEWLIST") { Library_ACCREDACTIONVIEWLIST_Output("Active",$GLOBALS{'LOGIN_domain_id'}); }
if ($selectid == "ACCREDACTIONTRACKER") { Library_ACCREDACTIONTRACKER_Output("Active",$GLOBALS{'LOGIN_domain_id'}); }
...
if ($selectid == "SETUPCORCURRENTUSE") { Cor_SETUPCORCURRENTUSE_Output(); }
...
if ($selectid == "DMWSSULISTARCHIVED") { Dmws_DMWSSULIST_Output('Archived'); }
...
if ($selectid == "SETUPSFMTEAM") { SFM_SETUPSFMTEAM_Output(); }
if ($selectid == "SETUPSFMFACILITY") { SFM_SETUPSFMFACILITY_Output(); }
if ($selectid == "SETUPSFMOPERATOR") { SFM_SETUPSFMOPERATOR_Output(); }
...
if ($selectid == "SFMBYLEAGUELIST") { SFM_SFMBYLEAGUELIST_Output(); }
if ($selectid == "SFMSEARCHLIST") { SFM_SFMSEARCHLIST_Output(); }
...
if ($selectid == "SFMMASSUPLOAD") { SFM_SFMMASSUPLOAD_Output(); }
if ($selectid == "SFMFACILITYCREATOR") { SFM_SFMFACILITYCREATOR_Output(); }
if ($selectid == "SFMDATALISTSUPDATE") { SFM_SFMDATALISTSUPDATE_Output(); }
if ($selectid == "SFMCOPYIMAGES") { SFM_SFMCOPYIMAGES_Output(); }
if ($selectid == "SFMTEAMDIVISIONDOWNLOAD") { SFM_SFMTEAMDIVISIONDOWNLOAD_Output(); }
if ($selectid == "SFMKEYCHANGEDOWNLOAD") { SFM_SFMKEYCHANGEDOWNLOAD_Output(); }
if ($selectid == "SETUPSFMADDTEAM") { SFM_SETUPSFMADDTEAM_Output(); }
