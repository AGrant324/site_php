...
pdf_show_xy($pdf, "<Type your info here>",60, 200);
pdf_show_xy($pdf, "Sample PDF, constructed by PHP in real-time.", 50, 750);
pdf_show_xy($pdf, "Made with the PDF libraries for PHP.", 50, 730);
pdf_show_xy($pdf, "A JPEG image, on 60 % of its original size.", 50, 710);
...
pdf_fit_image($pdf, $gif_image, 200, 400, "scale 1.5" );
