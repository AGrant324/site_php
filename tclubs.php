...
if ( $batch == "V" ) {array_push($countya, "West Sussex"); }
...
if ( $batch == "WT" ) {array_push($countya, "Wales"); }

if ( $batch == "J" ) {array_push($countya, "Brecknockshire"); }
if ( $batch == "J" ) {array_push($countya, "Caernarfonshire"); }
if ( $batch == "J" ) {array_push($countya, "Carmarthenshire"); }
if ( $batch == "J" ) {array_push($countya, "Cardiganshire"); }
if ( $batch == "J" ) {array_push($countya, "Denbighshire"); }
if ( $batch == "J" ) {array_push($countya, "Flintshire"); }
if ( $batch == "J" ) {array_push($countya, "Glamorgan"); }
if ( $batch == "J" ) {array_push($countya, "Monmouthshire"); }
if ( $batch == "J" ) {array_push($countya, "Pembrokeshire"); }

if ( $batch == "ST" ) {array_push($countya, "Scotland"); }

if ( $batch == "K" ) {array_push($countya, "Aberdeenshire"); }
if ( $batch == "K" ) {array_push($countya, "Angus"); }
if ( $batch == "K" ) {array_push($countya, "Argyllshire"); }
if ( $batch == "K" ) {array_push($countya, "Ayrshire"); }
if ( $batch == "K" ) {array_push($countya, "Dumfriesshire"); }
if ( $batch == "K" ) {array_push($countya, "Dunbartonshire"); }
if ( $batch == "K" ) {array_push($countya, "East Lothian"); }
if ( $batch == "L" ) {array_push($countya, "Fife"); }
if ( $batch == "L" ) {array_push($countya, "Lanarkshire"); }
if ( $batch == "L" ) {array_push($countya, "Midlothian"); }
if ( $batch == "L" ) {array_push($countya, "Morayshire"); }
if ( $batch == "L" ) {array_push($countya, "Peeblesshire"); }
if ( $batch == "L" ) {array_push($countya, "Perthshire"); }
if ( $batch == "L" ) {array_push($countya, "Renfrewshire"); }
if ( $batch == "L" ) {array_push($countya, "Stirlingshire"); }
...
foreach ($countya as $county) {
    ...
    if ($tr1 == "R") {
        ...
        $url = 'http://tennishub.co.uk/tennis-clubs-by-region/'.$county;
...
foreach ($countya as $county) {
    ...
    if ( $ci < 5 ) {
        ...
        for ($pi = 1; $pi <= $countypagesa[$county]; $pi++) {
            sleep(0.5);
            $clubname = "";
            $clubaddr = "";
            $clubpostcode = "";
            ...
            $url = 'http://tennishub.co.uk/tennis-clubs-by-county/'.$county.$endtext;
            $url = 'http://tennishub.co.uk/tennis-clubs-by-region/'.$county.$endtext;
            $url = str_replace(" ","%20",$url);
            echo $url."<br>";
            if ($tr2 == "R") {
                $html = file_get_contents($url);
