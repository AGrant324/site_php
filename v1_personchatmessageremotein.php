<<<<<<< HEAD
<?php # personchatmessageremotein.php
...
Get_Data("person",$inchatviewerpersonid);
...
$GLOBALS{'chatmessage_personid'} = $inchatviewerpersonid;
...
Person_TEAMCHAT_Output("remote",$inchatviewerpersonid, $inchatmessage_threadset, $GLOBALS{'chatmessage_threadid'});
