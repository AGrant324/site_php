...
XH1("Course Booking - ".$GLOBALS{'course_title'});
if (($incourseattendee_sname == "")||($incourseattendee_fname == "")||($incourseattendee_dob == "0000-00-00")) {
	...
	Booking_CourseBooking_Output($incourse_id,$incourseattendee_fname, $incourseattendee_sname,$incourseattendee_dob);
} else {
	...
	if ($foundcourseattendee_id != "") {
		...
		XPTXT("Thank you for your interest in the course. We have noted that ".$incourseattendee_fname." has attended one of our courses before.");
		...
		if ($foundperson_id != "") {
			...
			XPTXT("Thank you for your interest in the course. We have noted that ".$incourseattendee_fname." is a member of ".$GLOBALS{'domain_longname'}." and we have prefilled the form with information from the club records.");
			XPTXT("Please check that the information is up to date and change as necessary.");
		} else {
			// ======= Non Club Member =======================
			...
			XPTXT("Thank you for your interest in the course.");
			XPTXT("Please complete the following information.");			
		}
	...
	XFORM("bookingcoursein2.php","coursein2");
	XINSTDHID();
	...
	X_TABLE();
	XBR();XBR();
	XBR();XH2("Course Requirements");
	XPTXT($GLOBALS{'course_requirements'});
	// XBR();XH2("Terms and Conditions");
