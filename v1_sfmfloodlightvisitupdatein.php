...
if ($insubmitaction == "Save") {    
    ...
    if ( $insfmfloodlightvisit_id == "New" ) {
        ...
        Write_Data('sfmfloodlightvisit', $insfmfloodlightvisit_sfmfacilityid, $thissfmfloodlightvisit_id);    
    } else {
        $thissfmfloodlightvisit_id = $insfmfloodlightvisit_id;
        Get_Data('sfmfloodlightvisit', $insfmfloodlightvisit_sfmfacilityid, $thissfmfloodlightvisit_id);
    }
    ...
    foreach ( $_REQUEST as $keystring => $v ) {
        ...
        if ($GLOBALS{'LOGIN_person_id'} == "bbra") {
            if (($keybits[0] == "sfmfloodlightvisit")||($keybits[0] == "sfmfacility")) {
    ...
    Write_Data('sfmfacility', $insfmfloodlightvisit_sfmfacilityid);
    Write_Data('sfmfloodlightvisit', $insfmfloodlightvisit_sfmfacilityid, $thissfmfloodlightvisit_id);
    // XPTXT($insfmfloodlightvisit_sfmfacilityid." ".$thissfmfloodlightvisit_id);
    
    XPTXTCOLOR("Updates applied","green");
    
    SFM_SFMFLOODLIGHTVISIT_Output($insfmclub_id,$insfmfloodlightvisit_sfmfacilityid,$thissfmfloodlightvisit_id,$incurrenttab);
}
