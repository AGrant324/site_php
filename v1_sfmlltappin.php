...
if ( $insfmfloodlightvisit_id == "New" ) {
    ...
    Write_Data('sfmfloodlightvisit', $insfmground_id, $thissfmfloodlightvisit_id);    
} else {
    $thissfmfloodlightvisit_id = $insfmfloodlightvisit_id;
    Get_Data('sfmfloodlightvisit', $insfmground_id, $thissfmfloodlightvisit_id);
}
...
Write_Data('sfmfloodlightvisit', $insfmground_id, $thissfmfloodlightvisit_id);
// XPTXT($insfmground_id." ".$thissfmfloodlightvisit_id);
